...
plot(testTraces,legend = F, colour_by="protein_id",design_matrix = design_matrix,name="PRPF8_pepTraces",PDF=T)
plot(testTraces,legend = T, colour_by="isoform_id",design_matrix = design_matrix)

testTraces <- subset(pepTraces,trace_subset_ids="P09651",trace_subset_type = "protein_id")
plot(testTraces,legend = T,design_matrix = design_matrix)
plot(testTraces,legend = T, colour_by="proteoform_id",design_matrix = design_matrix)
plot(testTraces,legend = T, colour_by="protein_id",design_matrix = design_matrix)
plot(testTraces,legend = F,log=T, colour_by="proteoform_id",design_matrix = design_matrix,name="HNRNPA1_pepTraces",PDF=T)
plot(testTraces,legend = T, colour_by="isoform_id",design_matrix = design_matrix)


testTraces <- subset(pepTraces,trace_subset_ids="P14866",trace_subset_type = "protein_id")
plot(testTraces,legend = T, colour_by="proteoform_id",design_matrix = design_matrix,name="HNRNPL_pepTraces",PDF=T)
plot(testTraces,legend = T,log=T, colour_by="proteoform_id",design_matrix = design_matrix,name="HNRNPL_log_pepTraces",PDF=T)

testTraces <- subset(pepTraces,trace_subset_ids="Q9HB71",trace_subset_type = "protein_id")
plot(testTraces,legend = T, colour_by="proteoform_id",design_matrix = design_matrix,name="CACYBP_Q9HB71_pepTraces",PDF=T)
plot(testTraces,legend = T,log=T, colour_by="proteoform_id",design_matrix = design_matrix,name="CACYBP_Q9HB71_log_pepTraces",PDF=T)


testTraces <- subset(pepTraces,trace_subset_ids="P42167",trace_subset_type = "protein_id")
plot(testTraces,legend = T,design_matrix = design_matrix)
plot(testTraces,legend = T, colour_by="proteoform_id",design_matrix = design_matrix)
plot(testTraces,legend = T, colour_by="protein_id",design_matrix = design_matrix)
plot(testTraces,legend = F,log=T, colour_by="proteoform_id",design_matrix = design_matrix,name="LAP2_pepTraces",PDF=T)
plot(testTraces,legend = T, colour_by="isoform_id",design_matrix = design_matrix)

testTraces <- subset(pepTraces,trace_subset_ids="Q9H6S3",trace_subset_type = "protein_id")
plot(testTraces,legend = T,design_matrix = design_matrix)
plot(testTraces,legend = T, colour_by="proteoform_id",design_matrix = design_matrix)
plot(testTraces,legend = T, colour_by="protein_id",design_matrix = design_matrix)
plot(testTraces,legend = F,log=F, colour_by="proteoform_id",design_matrix = design_matrix,name="EPS8L2_pepTraces",PDF=T)
plot(testTraces,legend = T, colour_by="isoform_id",design_matrix = design_matrix)
