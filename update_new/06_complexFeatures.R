...
plotSummarizedMScoverage(hypotheses = corumHypotheses, protTracesSum, PDF = T)
...
plotSummarizedComplexes(scoredDataAll, corumHypotheses, protTracesSum, PDF=T, name="complex_completeness_pie")
