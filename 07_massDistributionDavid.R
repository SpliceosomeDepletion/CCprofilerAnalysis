...
david_moreAssembled <- fread("more_assembled_enrichment_DAVID.txt")
...
david_lessAssembled <- fread("less_assembled_enrichment_DAVID.txt")
...
david_noChange <- fread("noChange_enrichment_DAVID.txt")
