...
#' and (c) detect mixture-resolved protein peak-groups 
#' 
...
#' criterion (adj. p-value > 0.05). The resulting traces (peptide_traces_highCorr) are 
...
#' criterion (adj. p-value > 0.05). The resulting traces (peptide_traces_highCorr) are 
#' used to generate 50 mixture traces (peptide_traces_highCorr_mixed). For the feature 
...
#' proteoform specific features, the completeness is adjusted accroding to the proteoforms 
#' talking part in the feature. The proteoform resolution removes proteoforms within a mixed 
