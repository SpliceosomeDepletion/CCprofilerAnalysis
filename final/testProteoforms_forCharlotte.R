...
if (length(grep("nas21.ethz.ch",getwd()))>0) {
  ...
  load_all()
  setwd("~/mysonas/PRPF8/analysis/output/HEK")
  knitr::opts_knit$set(root.dir = '~/mysonas/PRPF8/analysis/output/HEK')
} else {
  setwd("/Volumes/ibludau-1/CCprofiler")
  load_all()
  setwd("/Volumes/ibludau-1/PRPF8/analysis/output/HEK")
  knitr::opts_knit$set(root.dir = '/Volumes/ibludau-1/PRPF8/analysis/output/HEK')
}

#' ## Load data
pep_traces <- readRDS("../../../../html/SECpaper/output_data/upstream_analysis/raw_pepTraces.rds")
calibration <-  readRDS("../../../../html/SECpaper/output_data/upstream_analysis/calibration.rds")
...
pdf(paste0("PeptideTraces_testProteoforms.pdf"))
