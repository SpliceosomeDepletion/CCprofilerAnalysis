...
plot(pepTest, design_matrix = design_matrix, log = FALSE, legend = F, PDF = TRUE,
     name = paste0("RAW_PeptideTraces_","PRPF8"), isoformAnnotation = F, plot = TRUE, highlight = NULL, highlight_col = NULL, colour_by = "protein_id")

test_proteins <- c("Q15029")
pepTest <- subset(traces_list, trace_subset_ids = test_proteins, trace_subset_type = "protein_id")
plot(pepTest, design_matrix = design_matrix, log = FALSE, legend = F, PDF = TRUE,
     name = paste0("RAW_PeptideTraces_","EFTUD2"), isoformAnnotation = F, plot = TRUE, highlight = NULL, highlight_col = NULL, colour_by = "protein_id")

test_proteins <- c("Q96DI7")
pepTest <- subset(traces_list, trace_subset_ids = test_proteins, trace_subset_type = "protein_id")
plot(pepTest, design_matrix = design_matrix, log = FALSE, legend = F, PDF = TRUE,
     name = paste0("RAW_PeptideTraces_","SNRNP40"), isoformAnnotation = F, plot = TRUE, highlight = NULL, highlight_col = NULL, colour_by = "protein_id")

test_proteins <- c("O75643")
pepTest <- subset(traces_list, trace_subset_ids = test_proteins, trace_subset_type = "protein_id")
plot(pepTest, design_matrix = design_matrix, log = FALSE, legend = F, PDF = TRUE,
     name = paste0("RAW_PeptideTraces_","SNRNP200"), isoformAnnotation = F, plot = TRUE, highlight = NULL, highlight_col = NULL, colour_by = "protein_id")
