...
if (length(grep("nas22.ethz.ch",getwd()))>0) {
  ...
  setwd("~/myspectrumscale/PRPF8/analysis/output/benchmark")
  knitr::opts_knit$set(root.dir = '~/myspectrumscale/PRPF8/analysis/output/benchmark')
} else if (length(grep("/Volumes/ibludau-1/",getwd()))>0) {
  setwd("/Volumes/ibludau-1/CCprofiler")
  load_all()
  suppressPackageStartupMessages(setwd("/Volumes/ibludau-1/PRPF8/analysis/output/benchmark"))
  ...
  load_all()
  setwd("~/Desktop/CCprofiler_analysis/PRPF8/benchmark")
}
...
source("../../CCprofilerAnalysis/thesis/generateMixtureTraces.R")
